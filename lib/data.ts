  ...
  history: [
    {
      ...
      date: "2026-06-18",
      title: "Control anual",
      notes: "Peso estable, dentadura sana. Se recomienda continuar con dieta actual.",
      vet: "Dra. Camila Reyes",
    },
    {
      id: "h2",
      date: "2026-03-02",
      title: "Desparasitación",
      notes: "Aplicación de antiparasitario interno y externo. Sin reacciones adversas.",
      vet: "Dr. Ignacio Paredes",
    },
    {
      id: "h3",
      date: "2025-11-10",
      title: "Refuerzo vacunal",
      notes: "Aplicación de vacuna séxtuple. Próximo refuerzo en 12 meses.",
      vet: "Dra. Camila Reyes",
    },
  ],
};
...
export const news: NewsItem[] = [
  {
    ...
    excerpt:
      "Repasamos las vacunas esenciales para perros y gatos, y por qué mantener las fechas al día evita enfermedades graves.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Cachorros, adultos y senior tienen necesidades distintas. Aquí una guía simple para leer etiquetas y raciones.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Desde la evaluación inicial hasta la adaptación en casa: todo lo que debes preparar antes de adoptar.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Un veterinario explica los síntomas que nunca debes ignorar y cuándo pedir hora con urgencia.",
    image:
      "https://mascoterias.com/blog/wp-content/uploads/2022/11/unnamed.jpg",
    readMinutes: 3,
  },
  {
    id: "n5",
    ...
    excerpt:
      "Pequeños cambios en casa que reducen el estrés y mejoran la salud mental de tu mascota.",
    image:
      "https://images.unsplash.com/photo-1591160690555-5debfba289f0?q=80&w=1200&auto=format&fit=crop",
    readMinutes: 4,
  },
];
